...
> [!NOTE]
> by calling the `compile` command you will run the **MSVC** compiler with the `vs2022` solution by default. **this might not work if you dont have Visual Studio 2022 installed!**
